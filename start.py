...
class FileDialog(wx.Frame):
  def __init__(self):
    wx.Frame.__init__(self,None,-1,"",(500,220),(185,60),wx.CAPTION|wx.CLOSE_BOX|wx.MINIMIZE_BOX)
    b1 = wx.Button(self, -1, u"浏览",(0,0))
    self.Bind(wx.EVT_BUTTON, self.OnButton1,b1)

    b2 = wx.Button(self, -1, u"开始测试",(90,0))
  ...
  def Svm(self,event):
    try:
      ...
      x = ft.hog(gray, orientations=9, pixels_per_cell=(8,8), cells_per_block=(3,3), block_norm='L2-Hys')
      print u'识别中……'
      i = clf.predict([x])
      print u'识别结果：',
